...
class TimeSlotService
{
    ...
    /**
     * Desbloquea slots bloqueados por el admin: los devuelve a 'available' y
     * limpia el motivo de bloqueo. A diferencia de releaseSlots(), este método
     * sí actúa sobre slots con status 'blocked'.
     */
    public function unblockSlots(array $slotIds): void
    {
        TimeSlot::whereIn('id', $slotIds)
