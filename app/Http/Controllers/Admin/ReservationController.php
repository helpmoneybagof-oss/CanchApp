...
class ReservationController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Si no se pasó user_id, crear un usuario walk-in con el nombre y teléfono
        // dados. Usamos un email único en el dominio @walkin.local para diferenciarlos.
    ...
    public function rejectPayment(Request $request, Reservation $reservation, PushNotificationService $push, NotificationService $notif): RedirectResponse
    {
        ...
        // Notificación DB + Push al cliente que fue rechazado
        try {
    ...
    public function unblockSlots(Request $request): JsonResponse
    {
        ...
        $this->slotService->unblockSlots($request->slot_ids);
